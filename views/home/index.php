	...
	<div id="content" class="content">
		...
		<section class="banner">
			<div class="gallery-wrap owl-carousel">
				...
				<div class="item">
					<a class="banner-pointer">
						<picture>
							<img alt="" src="https://www.zequenz.com/wp-content/uploads/2023/03/Signature_2000x1124-min.jpg">
						</picture>
					</a>
					<div class="text-box">
				...
				<div class="item">
					<a class="banner-pointer">
						<picture>
							<img alt="" src="https://www.zequenz.com/wp-content/uploads/2023/03/The-Color_836x1380.jpg">
						</picture>
					</a>
					<div class="text-box">
				...
				<div class="item">
					<a class="banner-pointer">
						<picture>
							<img alt="" src="https://www.zequenz.com/wp-content/uploads/2024/05/Untitled-1.jpg">
						</picture>
					</a>
					<div class="text-box">
				...
				<div class="item">
					<a class="banner-pointer">
						<picture>
							<img alt="" src="https://www.zequenz.com/wp-content/uploads/2024/11/Untitled-1.jpg">
						</picture>
					</a>
					<div class="text-box">
						...
						<div class="owl-carousel box-List py-3">
							...
							<div class="item">
								<a href="../product/detail.php">
									...
									<div class="box-text">
										<h6 class="text-line1">Architecture Lighting</h6>
										<p class="text-line4 m-0">serves and enhances certain architectural elements to foster, establish or emphasize a building’s aesthetic</p>
									</div>
								</a>
							</div>
							<div class="item">
								<a href="../product/detail.php">
									...
									<div class="box-text">
										<h6 class="text-line1">Facade Lighting</h6>
										<p class="text-line4 m-0">serves and enhances certain architectural elements to foster, establish or emphasize a building’s aesthetic</p>
									</div>
								</a>
							</div>
							<div class="item">
								<a href="../product/detail.php">
									...
									<div class="box-text">
										<h6 class="text-line1">Decorative Lighting</h6>
										<p class="text-line4 m-0">serves and enhances certain architectural elements to foster, establish or emphasize a building’s aesthetic</p>
									</div>
								</a>
							</div>
