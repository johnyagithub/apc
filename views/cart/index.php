            ...
            <form action="../quotation/" method="post">
              <div class="text-left font-weight-normal">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item px-3">
                    <div class="row gutters-5">
                      ...
                      <div class="col-lg col-sm-3 col-4 order-4 order-lg-0 d-flex align-content-center flex-wrap align-items-center">
                      ...
                      <div class="col-lg col-sm-3 col-5 order-3 order-lg-0 my-3 my-lg-0 d-flex align-content-center flex-wrap align-items-center justify-content-center">
                ...
                <div class="p-3 py-2 d-flex justify-content-end">
                  <h5 class="mb-0 mr-4">ราคาทั้งหมด</h5>
                  <span class="fs-20">฿ <span class="box-sumTotal">540</span></span>
                </div>
              </div>
