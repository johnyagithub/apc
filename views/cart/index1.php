            ...
            <form action="../quotation/" method="post">
              ...
              <div class="row align-items-center py-4">
                <div class="col-md-12 text-center text-md-right" id="requestQuote">
                  <button type="button" class="btn btn-dark btn-sm mx-2" onclick="$('#requestQuote').slideUp();$('#requestQuoteForm').slideDown();">ขอรับใบเสนอราคา</button>
                  <button type="submit" class="btn btn-primary btn-sm mx-2">ดำเนินการสั่งซื้อ</button>
                </div>
              </div>
            </form>
